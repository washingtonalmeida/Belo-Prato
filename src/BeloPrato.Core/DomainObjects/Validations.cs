...
namespace BeloPrato.Core.DomainObjects
{
    public class Validations
    {
        ...
        public static void PhoneNumberInvalidThrowsException(string phoneNumber, string message)
        {
            var isPhoneNumber = phoneNumber != null 
                && Regex.Match(phoneNumber, @"^([1-9]{2})\s([9]{1})?([0-9]{4})-([0-9]{4})$").Success;
